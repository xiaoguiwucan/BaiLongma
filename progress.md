...
- Committed v2.1.237 as `5ef2fe4 feat: add voice event client capabilities`.
- Tagged and pushed `v2.1.237` to origin.
- Created local release assets: `backups/v2.1.237/BaiLongma-v2.1.237-source.tar.gz` and `backups/v2.1.237/BaiLongma-v2.1.237.bundle`.
- Created GitHub Release: https://github.com/xiaoguiwucan/BaiLongma/releases/tag/v2.1.237
