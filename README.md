...
- 内置 3 个微信群助手性格预设：主人数字分身、技术值班助手、幽默社交助手；点击预设只填充文本，确认后再保存生效；设置页会明显显示当前生效性格和未保存状态，也支持自定义性格。
- 接入 Honcho 群知识库：每个微信群独立 session/peer；设置页可按群查看原始消息、自动摘要、长期结论，可手动添加本群知识、删除结论或清空本群 session；群成员明确说“以后叫我大哥/我是你大哥”等称呼身份偏好时会即时沉淀为本群长期记忆。
